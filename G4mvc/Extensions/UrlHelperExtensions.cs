...
{
    public static string? Action(this IUrlHelper urlHelper, G4mvcActionRouteValues route)
        => urlHelper.RouteUrl(route);

    public static string? Action(this IUrlHelper urlHelper, G4mvcActionRouteValues route, string? protocol = null, string? hostName = null, string? fragment = null)
    ...
    public static string? RouteUrl(this IUrlHelper urlHelper, string? routeName, G4mvcActionRouteValues route, string? protocol = null, string? hostName = null, string? fragment = null)
