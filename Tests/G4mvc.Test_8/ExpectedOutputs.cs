...
internal class ExpectedOutputs(string? mvcClassName = null, string? linksClassName = null, bool altRoot = false, bool additionalStatic = false, bool withVpp = false, bool classesInternal = false, bool enumerateSubDirectories = false, bool excludeIco = false, bool excludeCss = false, bool customJsName = false) : ExpectedOutputsBase(mvcClassName, linksClassName, altRoot, additionalStatic, withVpp, classesInternal, enumerateSubDirectories, excludeIco, excludeCss, customJsName)
{
