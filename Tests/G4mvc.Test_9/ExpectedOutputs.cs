    ...
    : ExpectedOutputsBase(mvcClassName, linksHelperClassName, altRoot, additionalStatic, withVpp, vppForContent, classesInternal, classNamespace, enumerateSubDirectories, excludeIco, excludeCss, customJsName)
{
    public override string SharedClass => $$"""
        ...
        namespace {{nameof(G4mvc)}}.{{nameof(Test_9)}}.{{nameof(G4mvc)}}.Mvc;
    ...
    public override string TestPartialClass => $$"""
        ...
        {
            {{(ClassesInternal ? "private " : "")}}protected global::{{nameof(G4mvc)}}.{{nameof(Test_9)}}.{{nameof(G4mvc)}}.Mvc.TestPartialRoutes.TestPartialViews Views { get; } = {{MvcClassName}}.TestPartial.Views;
    ...
    public override string IndexPageRoutes => $$"""
        ...
        namespace {{nameof(G4mvc)}}.{{nameof(Test_9)}}.{{nameof(G4mvc)}}.RazorPages;
        {{(ClassesInternal ? "internal" : "public")}} partial class IndexRoutes
        {
        	...
        	public {{nameof(G4mvcPageRouteValues)}} Post(global::{{nameof(G4mvc)}}.{{nameof(Test_9)}}.Pages.TestFormModel? testModel)
        	{
        		var route = Post();
        	...
        	public {{nameof(G4mvcPageRouteValues)}} PostAlternative(global::{{nameof(G4mvc)}}.{{nameof(Test_9)}}.Pages.TestFormModel? testModel)
        	{
    ...
    public override string SampleIndexPageRoutes => $$"""
        ...
        {{(ClassesInternal ? "internal" : "public")}} partial class SampleRoutes
        {
            ...
            {{(ClassesInternal ? "internal" : "public")}} partial class IndexRoutes
            {
            	...
            	public {{nameof(G4mvcPageRouteValues)}} Post(global::{{nameof(G4mvc)}}.{{nameof(Test_9)}}.Pages.Sample.TestFormModel? testModel)
            	{
            		var route = Post();
            	...
            	public {{nameof(G4mvcPageRouteValues)}} PostAlternative(global::{{nameof(G4mvc)}}.{{nameof(Test_9)}}.Pages.Sample.TestFormModel? testModel)
            	{
            		var route = PostAlternative();
    ...
    public override string MvcClass => $$"""
        using {{nameof(G4mvc)}}.{{nameof(Test_9)}}.{{nameof(G4mvc)}}.Mvc;
    ...
    public override string RazorPagesClass => $$"""
        using {{nameof(G4mvc)}}.{{nameof(Test_9)}}.{{nameof(G4mvc)}}.RazorPages;
