...
[TestClass]
public class G4mvcTests() : G4mvcTestBase(LanguageVersion.CSharp12, $"{nameof(G4mvc)}.{nameof(Test_10)}")
{
    [TestMethod]
    ...
    {
        const string classNamespace = $"{nameof(G4mvc)}.{nameof(Test_10)}.Routes";
