    ...
    : ExpectedOutputsBase(mvcClassName, linksHelperClassName, altRoot, additionalStatic, withVpp, vppForContent, classesInternal, classNamespace, enumerateSubDirectories, excludeIco, excludeCss, customJsName)
{
    public override string SharedClass => $$"""
        ...
        namespace {{nameof(G4mvc)}}.{{nameof(Test_10)}}.{{nameof(G4mvc)}}.Mvc;
    ...
    public override string TestPartialClass => $$"""
        ...
        namespace G4mvc.{{nameof(Test_10)}}.Controllers;
        public partial class TestPartialController
        {
            {{(ClassesInternal ? "private " : "")}}protected global::{{nameof(G4mvc)}}.{{nameof(Test_10)}}.{{nameof(G4mvc)}}.Mvc.TestPartialRoutes.TestPartialViews Views { get; } = {{MvcClassName}}.TestPartial.Views;
    ...
    public override string IndexPageRoutes => $$"""
        ...
        namespace {{nameof(G4mvc)}}.{{nameof(Test_10)}}.{{nameof(G4mvc)}}.RazorPages;
        {{(ClassesInternal ? "internal" : "public")}} partial class IndexRoutes
        {
        	...
        	public {{nameof(G4mvcPageRouteValues)}} Post(global::{{nameof(G4mvc)}}.{{nameof(Test_10)}}.Pages.TestFormModel? testModel)
        	{
        		var route = Post();
        	...
        	public {{nameof(G4mvcPageRouteValues)}} PostAlternative(global::{{nameof(G4mvc)}}.{{nameof(Test_10)}}.Pages.TestFormModel? testModel)
        	{
    ...
    public override string SampleIndexPageRoutes => $$"""
        ...
        {{(ClassesInternal ? "internal" : "public")}} partial class SampleRoutes
        {
            ...
            {{(ClassesInternal ? "internal" : "public")}} partial class IndexRoutes
            {
            	...
            	public {{nameof(G4mvcPageRouteValues)}} Post(global::{{nameof(G4mvc)}}.{{nameof(Test_10)}}.Pages.Sample.TestFormModel? testModel)
            	{
            		var route = Post();
            	...
            	public {{nameof(G4mvcPageRouteValues)}} PostAlternative(global::{{nameof(G4mvc)}}.{{nameof(Test_10)}}.Pages.Sample.TestFormModel? testModel)
            	{
            		var route = PostAlternative();
    ...
    public override string MvcClass => $$"""
        using {{nameof(G4mvc)}}.{{nameof(Test_10)}}.{{nameof(G4mvc)}}.Mvc;
    ...
    public override string RazorPagesClass => $$"""
        using {{nameof(G4mvc)}}.{{nameof(Test_10)}}.{{nameof(G4mvc)}}.RazorPages;
    ...
    public override string LinksClass => WithVpp
        ...
        {{(ClassesInternal ? "internal" : "public")}} static partial class {{LinksHelperClassName}}
        {
            ...
            public static readonly {{nameof(G4mvcContentLink)}} @favicon_ico = new("~/favicon.ico", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});

            public static partial class @css
            {
                public const string UrlPath = "~/css";
                public static readonly {{nameof(G4mvcContentLink)}} @site_css = new("~/css/site.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
            }

            public static partial class @js
            {
                public const string UrlPath = "~/js";
                public static readonly {{nameof(G4mvcContentLink)}} @site_js = new("~/js/site.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
            }
            ...
            public static partial class @lib
            {
                ...
                public static partial class @bootstrap
                {
                    ...
                    public static readonly {{nameof(G4mvcContentLink)}} @LICENSE = new("~/lib/bootstrap/LICENSE", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                    ...
                    public static partial class @dist
                    {
                        ...
                        public static partial class @css
                        {
                            ...
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_grid_css = new("~/lib/bootstrap/dist/css/bootstrap-grid.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_grid_css_map = new("~/lib/bootstrap/dist/css/bootstrap-grid.css.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_grid_min_css = new("~/lib/bootstrap/dist/css/bootstrap-grid.min.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_grid_min_css_map = new("~/lib/bootstrap/dist/css/bootstrap-grid.min.css.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_reboot_css = new("~/lib/bootstrap/dist/css/bootstrap-reboot.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_reboot_css_map = new("~/lib/bootstrap/dist/css/bootstrap-reboot.css.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_reboot_min_css = new("~/lib/bootstrap/dist/css/bootstrap-reboot.min.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_reboot_min_css_map = new("~/lib/bootstrap/dist/css/bootstrap-reboot.min.css.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_css = new("~/lib/bootstrap/dist/css/bootstrap.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_css_map = new("~/lib/bootstrap/dist/css/bootstrap.css.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_min_css = new("~/lib/bootstrap/dist/css/bootstrap.min.css", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_min_css_map = new("~/lib/bootstrap/dist/css/bootstrap.min.css.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        }

                        public static partial class @js
                        {
                            public const string UrlPath = "~/lib/bootstrap/dist/js";
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_bundle_js = new("~/lib/bootstrap/dist/js/bootstrap.bundle.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_bundle_js_map = new("~/lib/bootstrap/dist/js/bootstrap.bundle.js.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_bundle_min_js = new("~/lib/bootstrap/dist/js/bootstrap.bundle.min.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_bundle_min_js_map = new("~/lib/bootstrap/dist/js/bootstrap.bundle.min.js.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_js = new("~/lib/bootstrap/dist/js/bootstrap.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_js_map = new("~/lib/bootstrap/dist/js/bootstrap.js.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_min_js = new("~/lib/bootstrap/dist/js/bootstrap.min.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                            public static readonly {{nameof(G4mvcContentLink)}} @bootstrap_min_js_map = new("~/lib/bootstrap/dist/js/bootstrap.min.js.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        }
                    }
                }
                ...
                public static partial class @jquery
                {
                    ...
                    public static readonly {{nameof(G4mvcContentLink)}} @LICENSE_txt = new("~/lib/jquery/LICENSE.txt", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});

                    public static partial class @dist
                    {
                        public const string UrlPath = "~/lib/jquery/dist";
                        public static readonly {{nameof(G4mvcContentLink)}} @jquery_js = new("~/lib/jquery/dist/jquery.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        public static readonly {{nameof(G4mvcContentLink)}} @jquery_min_js = new("~/lib/jquery/dist/jquery.min.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        public static readonly {{nameof(G4mvcContentLink)}} @jquery_min_map = new("~/lib/jquery/dist/jquery.min.map", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                    }
                }
                ...
                public static partial class @jquery_validation
                {
                    ...
                    public static readonly {{nameof(G4mvcContentLink)}} @LICENSE_md = new("~/lib/jquery-validation/LICENSE.md", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});

                    public static partial class @dist
                    {
                        public const string UrlPath = "~/lib/jquery-validation/dist";
                        public static readonly {{nameof(G4mvcContentLink)}} @additional_methods_js = new("~/lib/jquery-validation/dist/additional-methods.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        public static readonly {{nameof(G4mvcContentLink)}} @additional_methods_min_js = new("~/lib/jquery-validation/dist/additional-methods.min.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        public static readonly {{nameof(G4mvcContentLink)}} @jquery_validate_js = new("~/lib/jquery-validation/dist/jquery.validate.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                        public static readonly {{nameof(G4mvcContentLink)}} @jquery_validate_min_js = new("~/lib/jquery-validation/dist/jquery.validate.min.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                    }
                }
                ...
                public static partial class @jquery_validation_unobtrusive
                {
                    ...
                    public static readonly {{nameof(G4mvcContentLink)}} @jquery_validate_unobtrusive_js = new("~/lib/jquery-validation-unobtrusive/jquery.validate.unobtrusive.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                    public static readonly {{nameof(G4mvcContentLink)}} @jquery_validate_unobtrusive_min_js = new("~/lib/jquery-validation-unobtrusive/jquery.validate.unobtrusive.min.js", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                    public static readonly {{nameof(G4mvcContentLink)}} @LICENSE_txt = new("~/lib/jquery-validation-unobtrusive/LICENSE.txt", {{Configuration.VppClassName}}.{{Configuration.VppMethodName}}, {{VppForContentStr}});
                }
            }
        }
        ...
        {{(ClassesInternal ? "internal" : "public")}} static partial class {{LinksHelperClassName}}
        {
            public const string UrlPath = "~";
            {{(ExcludeIco ? "" : $"""
                public static readonly {nameof(G4mvcContentLink)} @{(AltRoot ? "alt" : "")}favicon_ico = new("~/{(AltRoot ? "alt" : "")}favicon.ico");
            """)}}
            ...
            {{(ExcludeCss ? "" : $$"""
                ...
                {
                    public const string UrlPath = "~/css";
                    public static readonly {{nameof(G4mvcContentLink)}} @{{(AltRoot ? "alt" : "")}}site_css = new("~/css/{{(AltRoot ? "alt" : "")}}site.css");
                }
                """)}}
            ...
            {
                public const string UrlPath = "~/js";
                public static readonly {{nameof(G4mvcContentLink)}} @{{(AltRoot ? "alt" : "")}}site_js = new("~/js/{{(AltRoot ? "alt" : "")}}site.js");
            }
