    ...
    public partial Dictionary<string, string> Get()
    {
        return new()
        {
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\SharedRoutes.generated.cs"] = $$"""
                ...
                namespace {{nameof(G4mvc)}}.{{nameof(G4mvc)}}.Mvc;
            ...
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\TestPartialController.generated.cs"] = $$"""
                ...
                {{(_classNamespace is null ? "" : $"using {_classNamespace};")}}

                
                namespace G4mvc.Controllers;
                public partial class TestPartialController
                {
                    {{(_classesInternal ? "private " : "")}}protected global::{{nameof(G4mvc)}}.{{nameof(G4mvc)}}.Mvc.TestPartialRoutes.TestPartialViews Views { get; } = {{_mvcClassName}}.TestPartial.Views;
            ...
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\IndexRoutes.generated.cs"] = $$"""
                ...
                namespace {{nameof(G4mvc)}}.{{nameof(G4mvc)}}.RazorPages;
                {{(_classesInternal ? "internal" : "public")}} partial class IndexRoutes
                {
                    ...
                    public {{nameof(G4mvcPageRouteValues)}} Post(global::{{nameof(G4mvc)}}.Pages.TestFormModel? testModel)
                    {
                        var route = Post();
                    ...
                    public {{nameof(G4mvcPageRouteValues)}} PostAlternative(global::{{nameof(G4mvc)}}.Pages.TestFormModel? testModel)
                    {
                ...
                """,
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\SampleRoutes.generated.cs"] = $$"""
                using {{nameof(G4mvc)}};
                ...
                {{(_classesInternal ? "internal" : "public")}} partial class SampleRoutes
                {
                    ...
                    {{(_classesInternal ? "internal" : "public")}} partial class IndexRoutes
                    {
                        ...
                        public {{nameof(G4mvcPageRouteValues)}} Post(global::{{nameof(G4mvc)}}.Pages.Sample.TestFormModel? testModel)
                        {
                            var route = Post();
                        ...
                        public {{nameof(G4mvcPageRouteValues)}} PostAlternative(global::{{nameof(G4mvc)}}.Pages.Sample.TestFormModel? testModel)
                        {
                            var route = PostAlternative();
                ...
                """,
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\MVC.generated.cs"] = $$"""
                using {{nameof(G4mvc)}}.{{nameof(G4mvc)}}.Mvc;

                {{(_classNamespace is null ? "" : $"namespace {_classNamespace};\n")}}
                ...
                """,
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\RazorPages.generated.cs"] = $$"""
                using {{nameof(G4mvc)}}.{{nameof(G4mvc)}}.RazorPages;
        
                {{(_classNamespace is null ? "" : $"namespace {_classNamespace};\n")}}
                
                {{(_classesInternal ? "internal" : "public")}} class RazorPages
                {
                    //v1;
                ...
                """,
            ["G4mvc.Generator\\G4mvc.Generator.G4mvcGenerator\\Links.generated.cs"] = _withVpp
                ? $$"""
                using {{nameof(G4mvc)}};
